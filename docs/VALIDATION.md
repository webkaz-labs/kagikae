...
|---|---|---|
| claude | `realpath(command -v claude)` (one Mach-O, JS inline) | `2.1.260` |
...
| opencode | `realpath(command -v opencode)` (Bun single-file executable) | `1.18.25` |
| agy | `realpath(command -v agy)` (Go binary; SHA-256 `dea6443f3167d0ff1af9adf0bc9f96f13be85c8206a399bd33e2de87fdc39f7a`) | `1.1.23` |
